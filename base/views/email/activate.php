...
<table bgcolor="#FFFFFF" cellpadding="0" cellspacing="0" class="nl-container" role="presentation"
    ...
    <tr style="vertical-align: top;" valign="top">
        <td style="word-break: break-word; vertical-align: top;" valign="top">
            ...
            <div style="background-color:#4fd2a5;">
                <div class="block-grid"
                     style="Margin: 0 auto; min-width: 320px; max-width: 675px; overflow-wrap: break-word; word-wrap: break-word; word-break: break-word; background-color: transparent;">
                    <div style="border-collapse: collapse;display: table;width: 100%;background-color:transparent;">
                        <!--[if (mso)|(IE)]>
                        <table width="100%" cellpadding="0" cellspacing="0" border="0"
                               style="background-color:#4fd2a5;">
                            <tr>
                                <td align="center">
                        ...
                        <td align="center" width="675"
                            style="background-color:transparent;width:675px; border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent;"
                            valign="top">
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                        ...
                        <![endif]-->
                        <div class="col num12"
                             style="min-width: 320px; max-width: 675px; display: table-cell; vertical-align: top; width: 675px;">
                            <div style="width:100% !important;">
                                ...
                                <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:30px; padding-bottom:30px; padding-right: 0px; padding-left: 0px;">
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                        <tr>
                                            <td style="padding-right: 10px; padding-left: 10px; padding-top: 35px; padding-bottom: 10px; font-family: 'Trebuchet MS', Tahoma, sans-serif">
                                    <![endif]-->
                                            ...
                                            <tr>
                                                <td style="padding-top: 15px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px"
                                                    ...
                                                    <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                                                                 ...
                                                                 style="height:34.5pt; width:201.75pt; v-text-anchor:middle;"
                                                                 arcsize="55%" stroke="false" fillcolor="#007089">
                                                        <w:anchorlock/>
                                                        <v:textbox inset="0,0,0,0">
                                                            <center style="color:#ffffff; font-family:'Trebuchet MS', Tahoma, sans-serif; font-size:18px">
                                        <![endif]-->
                                        <a href="<?php echo base_url() . '/'. current_lang() .'/activate/' . $activationToken ?>"
